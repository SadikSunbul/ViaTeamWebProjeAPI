...
public class UsersController : BaseController
{
    ...
    [HttpGet("GetFromAuth")]
    public async Task<IActionResult> GetFromAuth() //kullanıcı bılgıelrını getirir ıd sınden 
    {
    ...
    [HttpPut("FromAuth")] //Update From Auth
    public async Task<IActionResult> UpdateFromAuth([FromBody] UpdateUserFromAuthCommand updateUserFromAuthCommand)
    {
        updateUserFromAuthCommand.Id = getUserIdFromRequest(); //ıd sını otamasıt alarak guncelle
